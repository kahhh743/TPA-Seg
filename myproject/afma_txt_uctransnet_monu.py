...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_decode=[
            ...
            # dict(type='CrossEntropyLoss', loss_name='loss_ce', loss_weight=1.0, use_sigmoid=False,
            #      class_weight=[1 / (5 * 0.7979), 1 / (5 * 0.1243), 1 / (5 * 0.0421), 1 / (5 * 0.0020),
            #                    1 / (5 * 0.0337)]),
            dict(type='CrossEntropyLoss', loss_name='loss_ce', loss_weight=1.0, use_sigmoid=False,
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        # data_prefix=dict(
        #     img_path='train/img', seg_map_path='train/label-c5', text_path='train/label-c5/train_text_c5_class.txt'),
        data_prefix=dict(
