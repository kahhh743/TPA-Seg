...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            img_path='train/img', seg_map_path='train/label', text_path='train/label/test_text_c5.txt'),
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            img_path='val/img', seg_map_path='val/label', text_path='val/label/val_text_c5.txt'),
        pipeline=test_pipeline))
out= r'F:\Test\Pytest\mmsegmentation\work_dirs\myproject\uctransnet.py'
test_evaluator = [
    dict(type='MyIoUMetric', iou_metrics=['mIoU', 'mDice', 'mFscore'],
         output_dir=out,
         keep_results=True,
