...
class CLIP(BaseModel):
    ...
    def encode_prompt(self, data_samples):
        stack_list = []
        ...
        result = torch.stack(result, dim=0)     # n*26*768
    ...
    def calc_similarity(self, inputs, data_samples):
        ...
        # self.encode_prompt(data_samples)
    ...
    def loss(self, inputs, data_samples):
        logits_per_image, logits_per_text = self.calc_similarity(inputs, data_samples)
        ...
        loss_img = loss_fnc_img(logits_per_image, ground_truth)
        loss_txt = loss_fnc_txt(logits_per_text, ground_truth)
