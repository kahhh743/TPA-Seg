...
class My_PSPHead(BaseDecodeHead):
    ...
    def forward(self, inputs, inputs_img):
        """Forward function."""
    ...
    def loss(self, inputs: Tuple[Tensor], batch_data_samples: SampleList,
        ...
        """
        seg_logits = self.forward(inputs, inputs_img)

        losses = self.loss_by_feat(seg_logits, batch_data_samples, inputs_img)
        return losses
    ...
    def predict(self, inputs: Tuple[Tensor], batch_img_metas: List[dict],
        ...
        return self.predict_by_feat(seg_logits, batch_img_metas, inputs_img)

    def loss_by_feat(self, seg_logits: Tensor,
                     batch_data_samples: SampleList, inputs_img) -> dict:
    ...
    def predict_by_feat(self, seg_logits: Tensor,
                        batch_img_metas: List[dict], inputs_img) -> Tensor:
