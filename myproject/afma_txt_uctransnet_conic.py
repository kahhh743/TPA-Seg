...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            img_path='train/img', seg_map_path='train/label', text_path='train/train_text_c7.txt'),
        # data_prefix=dict(
        #     img_path='test/img', seg_map_path='test/label', text_path='test/train_text_c7.txt'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            img_path='val/img', seg_map_path='val/label', text_path='val/val_text_c7.txt'),
        # data_prefix=dict(
        #     img_path='test/img', seg_map_path='test/label', text_path='test/train_text_c7.txt'),
